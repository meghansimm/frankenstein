window.addEventListener('DOMContentLoaded', function() { // Use DOMContentLoaded for earlier execution
    const canvas = document.getElementById('existentialism');
    ...
    function loadAndStartAnimation() {
        ...
        effect.wrapText('Cursed creator! Why did you form a monster so hideous that even you turned from me in disgust?');
        animate();
    }
