window.addEventListener('DOMContentLoaded', function() { // Use DOMContentLoaded for earlier execution
    const canvas = document.getElementById('literature');
    ...
    class Particle {
        ...
        constructor(effect, x, y, color) {
            ...
            this.ease = Math.random() * 0.3 + 0.006;
    ...
    class Effect {
        ...
        constructor(context, canvasWidth, canvasHeight) {
            ...
            this.fontSize = 150; // Increased size for better effect
    ...
    function loadAndStartAnimation() {
        ...
        effect.wrapText('I found on the ground a leathern portmanteau, containing several articles of dress and some books.');
        animate();
    }
