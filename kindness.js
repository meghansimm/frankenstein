window.addEventListener('DOMContentLoaded', function() { // Use DOMContentLoaded for earlier execution
    const canvas = document.getElementById('kindness');
    ...
    let effect; // Declare `effect` outside the load function

    class Particle {
        // ... (your existing Particle class code)
    ...
    class Effect {
        // ... (your existing Effect class code)
        constructor(context, canvasWidth, canvasHeight) {
            this.context = context;
            this.canvasWidth = canvasWidth;
            this.canvasHeight = canvasHeight;
            this.textX = this.canvasWidth / 2; // Center the text initially
            this.textY = this.canvasHeight / 2;
            this.fontSize = 140; // Increased size for better effect
        ...
        wrapText(text) {
            ...
            this.context.font = this.fontSize + "px Hersey";
            ...
            for (let i = 0; i < words.length; i++) {
                ...
                if (this.context.measureText(testLine).width > this.maxTextWidth && i > 0) {
                    line = words[i] + ' ';
                    lineCounter++;
                } else {
                    line = testLine;
            ...
            this.textY = (this.canvasHeight / 2) - (textHeight / 2) + (this.lineHeight / 2);
    ...
    function loadAndStartAnimation() {
        ...
        effect.wrapText('I am blind, and cannot judge of your countenance, but there is something in your words which persuades me that you are sincere.');
        animate();
    }
