...
//                 // Update mouse.radius on scroll
//         window.addEventListener('scroll', () => {
//             // Calculate scroll progress (0 at the top, 1 at the bottom)
//             const scrollDistance = window.scrollY;
//             const maxScroll = document.documentElement.scrollHeight - window.innerHeight;
//             const scrollProgress = maxScroll > 0 ? Math.min(scrollDistance / maxScroll, 1) : 0;

//             // Map the scroll progress to the desired radius range
//             this.mouse.radius = minRadius + scrollProgress * (maxRadius - minRadius);
//         });
